...
private:
    ...
    volatile static ThreadPool<T> *thread_pool_ptr; // 单例模式指针
...
private:
        ...
        : thread_num_(num)
    {
        ...
        {
            threads_.push_back(new Thread(i, ThreadPool::routine, (void *)this));
            // threads_.push_back(new Thread(i, std::bind(&ThreadPool::routine, this, std::placeholders::_1), (void *)this));
        }
    }
...
template <class T>
volatile ThreadPool<T> *ThreadPool<T>::thread_pool_ptr = nullptr;
template <typename T>
